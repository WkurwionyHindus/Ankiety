...
public class App {
	public static void main(String[] args) throws IOException {
		...
		WebElement loginInput = driver
				.findElement(By.id("ctl00_ctl00_ContentPlaceHolder_MiddleContentPlaceHolder_txtIdent"));
		WebElement passInput = driver
				.findElement(By.id("ctl00_ctl00_ContentPlaceHolder_MiddleContentPlaceHolder_txtHaslo"));
		...
		while (driver.findElements(By.className("gridDane")).size() != 0) {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(
					By.id("ctl00_ctl00_ContentPlaceHolder_MiddleContentPlaceHolder_G0_G0_2904")));

			// frekwencja
			if (choose == 1) {
				frekwencja = Arrays.asList(driver
						.findElement(By.id("ctl00_ctl00_ContentPlaceHolder_MiddleContentPlaceHolder_G0_G0_2905")));
			} else if (choose == 2) {
				frekwencja = Arrays.asList(
						driver.findElement(By.id("ctl00_ctl00_ContentPlaceHolder_MiddleContentPlaceHolder_G0_G0_2904")),
						driver.findElement(
								By.id("ctl00_ctl00_ContentPlaceHolder_MiddleContentPlaceHolder_G0_G0_2905")));
			}
			// podpunkt 1
